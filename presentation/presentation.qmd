...
1. If you don't have Julia installed: download `juliaup` from https://github.com/JuliaLang/juliaup

2. Download the workshop repository to your computer:
